...
export const siteRoutes: SiteRoute[] = [
  ...
  },
  {
    ...
    description: 'AliasMode Cloud and Local are free with unlimited browser profiles. Premium Support adds direct help without feature gates.',
    kind: 'product',
  ...
  },
  {
    path: '/contact/',
    label: 'Contact',
    title: 'Contact and Premium Support',
    description: 'Contact AliasMode for product help, team onboarding, Premium Support, enterprise support, or responsible security reporting.',
    kind: 'product',
